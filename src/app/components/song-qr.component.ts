...
@Component({
    selector: 'song-qr',
    templateUrl: '../views/song-qr.html',
    providers: [UserService, AlbumService, SongService, CodigoService, ArtistService]

})

export class SongQrComponent implements OnInit {
    ...
    ngOnInit() {
        console.log('Song Qr component cargando');
            ...
            this._songService.getSong(this.token, id).subscribe(
                response => {
                    if (!response.song) {
                        ...
                        // this._albumService.getAlbum(this.token, response.song._id).subscribe(
                        //     response => {
                        //         if (!response.albums) {
    ...
    //                                     // Sacar los albums del artista
    //                                     this._songService.getSong(this.token, response.album._id).subscribe(
    //                                         response => {
    //                                             if (!response.song) {
